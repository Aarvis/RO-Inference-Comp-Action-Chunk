...
class RuntimePathsConfig:
    ...
    checkpoint_planner_config: Path
    checkpoint_planner_checkpoint: Path
...
class RuntimeConfig:
    ...
    planner_value_variant: str = "final"
...
def _parse_origami_comp_action_chunk_config(
    *,
    ...
    paths = RuntimePathsConfig(
        ooi_config=_require_path(paths_cfg.get("ooi_config"), config_dir=config_dir, field_name="paths.ooi_config"),
        ooi_checkpoint=_resolve_path(paths_cfg.get("ooi_checkpoint"), config_dir=config_dir),
        checkpoint_planner_config=_require_path(
            paths_cfg.get("checkpoint_planner_config"),
            config_dir=config_dir,
            field_name="paths.checkpoint_planner_config",
        ),
        checkpoint_planner_checkpoint=_require_path(
    ...
    runtime = RuntimeConfig(
        ...
        planner_value_variant=str(runtime_cfg.get("planner_value_variant", "final")),
