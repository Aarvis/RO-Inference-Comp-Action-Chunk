...
OOI runtime slice for `RO-Inference-Comp-Action-Chunk`.
...
- `E:/Robot-Origami-Challenge/RO-Inference-Comp-Action-Chunk/OOI_Module/configs/ooi_zoom_runtime.yaml`

Then run:

```powershell
cd E:\Robot-Origami-Challenge\RO-Inference-Comp-Action-Chunk\OOI_Module
