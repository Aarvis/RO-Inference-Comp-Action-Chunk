...
```text
RO-Inference-Comp-Action-Chunk/OpenPI_Module/configs/openpi_comp_action_chunk_runtime.yaml
```
...
```text
RO-Inference-Comp-Action-Chunk/OpenPI_Module/model_bundles/pi05_origami_comp_action_chunk
```
